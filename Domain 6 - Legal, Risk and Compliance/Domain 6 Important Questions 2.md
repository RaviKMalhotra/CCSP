...
C	is	incorrect	because	the	Health	Insurance	Portability	and Accountability	Act	(HIPAA)	was	implemented	by	the	United	States	in 1996	and	provides	security	for	the	privacy	and	protection	of	personal medical	records.
...
The	Payment	Card	Industry	Data	Security	Standard	(PCI	DSS)	is	a regulatory	framework	developed	by	the	major	credit	card	brands, designed	to	set	minimum	standards	for	merchants	to	follow	when processing	and	transmitting	data	across	their	networks	and	interacting with	their	payment	systems.
...
Compliance	with	regulations	is	considered	an	external	audit.	It	is done	by	an	independent	third	party	that	does	not	have	any	stake	or financial	interests	in	the	organization	undergoing	the	audit.	Most regulations	have	specific	requirements	as	to	the	type	of	audit,	and	in some	cases	who	the	appropriate	auditors	should	be	selected	from	as well.
...
After	the	formulation	of	security	policies,	the	next	step	is	to	define the	scope	of	the	ISMS	efforts,	which	will	define	and	drive	all	future activities	and	determine	what	is	to	be	included	and	to	what	extent.
...
The	ISO/IEC	27001:2013	security	standard	contains	14	different domains,	but	legal	is	not	one	that’s	specifically	mentioned.	However, even	though	legal	is	not	specifically	mentioned,	like	many	other concepts,	it	can	be	found	throughout	many	of	the	other	domains	to varying	degrees.
...
Customer	feedback,	although	very	important	to	an	organization, would	not	be	a	factor	in	a	gap	analysis,	because	it	would	not	have	any impact	on	security	configurations	or	their	deviations	from	policy	or baselines.
...
Remediation	of	any	findings	or	deficiencies	is	handled	after	the completion	of	an	audit,	but	is	not	a	part	of	the	actual	audit.	Although strategies	for	remediation	are	often	discussed	with	auditors	to	ensure that	steps	taken	will	satisfy	the	deficiency,	the	actual	remediation	of them	is	not	part	of	the	audit	itself.
