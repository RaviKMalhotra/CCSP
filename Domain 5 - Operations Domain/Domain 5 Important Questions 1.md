...
O**ption B is not optimum because of the potential for vendor lock-in, restrictions on buildout, and privacy concerns**.
...
### [important] Question # 22 - The American Society of Heating, Refrigeration, and Air Conditioning Engineers (ASHRAE) guidelines for internal environmental conditions within a data center suggest that a temperature setting of _______________ degrees (F) would be too high.                 
A. **93**            
B. 80              
C. 72             
D. 32             
...
The range **suggested by the ASHRAE Technical Committee 9.9 is 64 to 81 degrees Fahrenheit**. 
All the other options are distractors (although D is particularly distracting, because it is lower than the recommended range, but that is not what the question is asking).
...
### [important] Question # 36 - Which of these characteristics of a virtualized network adds risks to the cloud environment?            
A. Redundancy           
B. Scalability              
C. Pay-per-use            
D. Self-service 
...
### Question # 105 - Risk mitigation must always also entail which other method of addressing risk?                      
A. Risk acceptance                   
B. Risk avoidance                               
C. Risk transfer                                   
D. Risk attenuation                                            
