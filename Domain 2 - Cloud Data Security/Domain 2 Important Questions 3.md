...
##2 Question # 8.	An XML file is considered what type of data?
A.	Unstructured data
B.	Restructured data
...
### Question # 10.	Joanna’s company uses a load balancer to distribute traffic between multiple web servers. What data point is often lost when traffic passes through load balancers to local web servers in a cloud environment? A. The source IP address
...
46.	C. An IRM needs to maintain a 
